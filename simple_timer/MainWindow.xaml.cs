...
namespace simple_timer
{
    public partial class MainWindow : Window
    {
        ...
        {
            tm1.Start(comboBox_h, comboBox_m,comboBox_s,timer_label_h,timer_label_m,timer_label_s,timer_pause_1,T1_Elapsed, textBlock);
        }

        private void T1_Elapsed(object sender, ElapsedEventArgs e)
        {
            tm1.Tick(timer_label_h, timer_label_m, timer_label_s, timer_pause_1, textBlock);
        }
        ...
        {
            tm1.Reset(comboBox_h, comboBox_m, comboBox_s, timer_label_h, timer_label_m, timer_label_s, timer_pause_1, T1_Elapsed, textBlock);
        }
        ...
        {
            tm2.Start(comboBox_h2, comboBox_m2, comboBox_s2, timer_label_h2, timer_label_m2, timer_label_s2, timer_pause_2, T2_Elapsed, textBlock_2);
        }

        private void T2_Elapsed(object sender, ElapsedEventArgs e)
        {
            tm2.Tick(timer_label_h2, timer_label_m2, timer_label_s2, timer_pause_2, textBlock_2);
        }
        ...
        {
            tm2.Reset(comboBox_h2, comboBox_m2, comboBox_s2, timer_label_h2, timer_label_m2, timer_label_s2, timer_pause_2, T2_Elapsed, textBlock_2);
        }
        ...
        {
            tm3.Start(comboBox_h3, comboBox_m3, comboBox_s3, timer_label_h3, timer_label_m3, timer_label_s3, timer_pause_3, T3_Elapsed, textBlock_3);
        }

        private void T3_Elapsed(object sender, ElapsedEventArgs e)
        {
            tm3.Tick(timer_label_h3, timer_label_m3, timer_label_s3, timer_pause_3, textBlock_3);
        }
        ...
        {
            tm3.Reset(comboBox_h3, comboBox_m3, comboBox_s3, timer_label_h3, timer_label_m3, timer_label_s3, timer_pause_3, T3_Elapsed, textBlock_3);
        }
